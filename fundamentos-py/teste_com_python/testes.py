...
class AtividadesTestes(unittest.TestCase):
    ...
    def test_eh_engracada(self):
        ...
        # self.assertEqual(eh_engracada('Sérgio Malandro'), False)  # Manter o teste até implementar a função
        self.assertFalse(eh_engracada('Sérgio Malandro'))  # Se a funcao não estiver implementada, retornará None
